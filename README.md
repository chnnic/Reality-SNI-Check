...
- **10 大分类、124 个内置站点**：覆盖 CDN、云、科技、金融、大学、流媒体、社交、游戏、电商、区域锚点，可按需选测。
...
| `gaming` | 游戏平台 | 10 |
| `ecom` | 电商 / 零售 / 品牌 | 11 |
| `region` | 区域锚点（日 / 欧 / 东南亚 / 港 / 澳） | 13 |

跑全部 124 站会花点时间；日常按落地机大区选 2~3 个分类即可，例如新加坡落地机跑 `-c cdn,cloud,edu`。
...
证书验证结果不会单独占一列；证书无效会在“合规”列显示 `✗ 证书`，并从推荐排名中排除。
